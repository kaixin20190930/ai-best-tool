...
| EVD-02 | P1     | 工具页 Evidence Ledger UI       | 核心判断可以展开查看证据，不以单一分数替代解释                  |     1 天 | 已完成；等待 EVD-03 产生首批 verified 数据后自动展示 |
...
- 当前 37 条历史数据均为 candidate，因此上线后不会突然展示未经人工审核的证据；EVD-03 首次明确核验后，对应工具页会自动出
  现该模块。
