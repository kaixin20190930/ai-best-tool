...
| MON-01    | P1     | 30/90 天人工复核闭环           | 事实到期、判断到期和变化待审可筛选；复核依据与缺失基线可见      |   0.5 天 | 代码与生产数据审计完成；事实日历12/12可计算，判断基线8/12，余4项待真实复核；不包含自动抓取 |
...
- Runway于2026-09-06建立独立`decision`判断基线，事件`472944a6-e0aa-4363-8dc7-08d673386e07`。依据限定为官方credits、商业
  ...
  唯一回查，Evidence Ledger和Change Timeline不再静默缺失。MON判断日历因此变为8/12，时间线事件共15条。
