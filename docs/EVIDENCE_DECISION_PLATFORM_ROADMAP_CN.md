...
- 当前 CHG-02 真实进度为 8/10（2026-09-05新增Gamma、Luma Dream Machine、n8n、OpenRouter、Runway）。其余核心工具必须先完成 intelligence 抓取和至少一条人工或有审计记录的owner授权辅助claim核验，再建立基线；不会直接把
...
- OpenRouter定向采集建立7个官方来源、3条candidate、0冲突的档案。2026-09-05受控审核通过产品名、官网定位和公开价格页存在性；动态价格金额未被提取或发布。第7条公开基线创建成功，重复执行返回`baseline_already_exists`，下次复查为2026-10-05。
- Runway定向采集建立8个官方来源、4条candidate、0冲突的档案。2026-09-05受控审核通过产品名、官网定位和canonical价格页存在性，拒绝`/pricing?tab=dev`重复路由证据；第8条公开基线创建及重复幂等检查通过，下次复查为2026-10-05。
