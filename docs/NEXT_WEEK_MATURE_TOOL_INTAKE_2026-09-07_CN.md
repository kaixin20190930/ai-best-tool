...
| 3 | Otter.ai | AI 原生会议转录与会议助手；高评论量且有清晰免费/团队决策 | alias 本地收口完成，待部署验收与 09-10 发布日门禁 | 09-10 | 部署后确认双语 308；当日复核价格、额度、隐私再迁移 `otter-ai` |
...
| 2026-09-09 | Otter.ai alias 前置收口 | 通用 alias 机制增加 `otter -> otter-ai`；本地 production 双语旧路径均为 308，唯一 canonical 页面为 200/noindex，待部署后复验 |
