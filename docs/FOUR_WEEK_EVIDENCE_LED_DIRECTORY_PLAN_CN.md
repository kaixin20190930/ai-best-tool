...
| W3-01 | 第 3 周 | 变化监测与复查队列 | AI 发现变化，人工/owner 确认后更新事实 | 进行中（W3-01A） | Codex + 用户 |
...
| 子任务 | 实施细节 | 预计时间 | 依赖 | 验收 | 状态 |
| --- | --- | ---: | --- | --- | --- |
| W3-01A | AI 检测官网、定价、文档变化，只创建待审差异 | 1.5 天 | W1-02 | 不自动覆盖已核验事实 | 进行中；提交 `fdf1c1f6`，专项测试、tsc、完整 build 通过；等待执行 Supabase 迁移 |
