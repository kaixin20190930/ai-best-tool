...
| W3-02 | 第 3 周 | 真实信号闭环 | owner、纠错、评论能更新对应工具判断 | 进行中（W3-02A） | Codex + 用户 |
...
| W3-02A | owner 更新、纠错、评论映射到具体工具证据与判断 | 1 天 | W2-01B | 变更可追溯，不自动发布 | 进行中；提交 `b8f91227`，专项测试、tsc、完整 build 通过；等待 Supabase 迁移与首次同步 |
