...
2026-09-04 维护审计补充：今日两条公开收录虽符合每日公开 1–2 条，但同日两次索引批准违反每日最多 1 条的内部政策。进一步索引放行已暂停，先核对周额度并补统一写入保护；已部署状态与节奏合规必须分别判断。详见 [维护审计](./MAINTENANCE_AUDIT_2026-09-04_CN.md)。
