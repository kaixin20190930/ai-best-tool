...
| CL-02 Research              | CL-01                         | [Consensus 与两条 Task Capability 编辑证据包](./DECISION_GRAPH_CL02_RESEARCH_EDITORIAL_PACKET_2026-09-25_CN.md) | 直接官方证据、字段与 QA 通过；单组发布和只读回读，或明确 hold | 证据包已准备；待 CL-01 生产迁移与独立内容 QA | 1–2 人日 |
