...
这违反 2026-09-04 当时执行的“公开收录每日 1–2 个、索引放行每日最多 1 个且每周最多 5 个”的内部策略。该段保留历史审计口径；
2026-09-09 后的成熟工具每日 SLA、分层观察和每周 3 个运营上限以 [索引发布政策](./TOOL_INDEX_RELEASE_POLICY_CN.md) 为准。此前将“没有重复 canonical”误当作不受索
