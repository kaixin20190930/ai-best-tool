...
| IDX-06 | 高质量收录候选池与 "Best Decision Card" | 市场验证机制已完成；Claude/Anthropic 已合并为唯一 Claude 产品实体，下一项为 Fathom 数据库迁移与 locale 信号收口 | 进行中（成熟工具队列 1/10） | Codex + 用户 |
...
| CTR-06 | 首批成熟工具内容缺口 | Claude/Anthropic、Fathom、Gamma、Consensus、DeepL、Runway、Luma AI、Pipedream、Cursor、The Graph | 10 个既有 canonical URL 完成合并、数据库迁移或决策内容增强；Claude/Anthropic 已完成且未新增 URL | 进行中（1/10） | Codex |
