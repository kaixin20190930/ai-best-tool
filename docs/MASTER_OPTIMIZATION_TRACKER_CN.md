...
| IDX-06 | 高质量收录候选池与 "Best Decision Card" | Claude/Anthropic、Fathom、Gamma、Consensus、DeepL、Runway、Luma AI、Pipedream 已完成实体迁移或决策信号收口；下一项为 P1 Cursor | 进行中（成熟工具队列 8/10） | Codex + 用户 |
...
| CTR-06 | 首批成熟工具内容缺口 | Claude/Anthropic、Fathom、Gamma、Consensus、DeepL、Runway、Luma AI、Pipedream、Cursor、The Graph | 10 个既有 canonical URL 完成合并、数据库迁移或决策内容增强；前 8 项已完成且未新增 URL | 进行中（8/10） | Codex |
