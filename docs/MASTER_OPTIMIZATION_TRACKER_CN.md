...
| IDX-06 | 高质量收录候选池与 "Best Decision Card" | 成熟工具 P0 四项已完成；Claude/Anthropic、Fathom、Gamma、Consensus 均已完成实体迁移或信号收口，下一项为 P1 DeepL 决策意图增强 | 进行中（成熟工具队列 4/10） | Codex + 用户 |
...
| CTR-06 | 首批成熟工具内容缺口 | Claude/Anthropic、Fathom、Gamma、Consensus、DeepL、Runway、Luma AI、Pipedream、Cursor、The Graph | 10 个既有 canonical URL 完成合并、数据库迁移或决策内容增强；P0 四项已完成且未新增 URL | 进行中（4/10） | Codex |
