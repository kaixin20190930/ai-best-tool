...
- Descript 深审已完成：生产无实体，现有英中 canonical 静态页继续 `noindex` 且不在 sitemap；产品身份、逐席位定价、media hours、AI credits、团队共享池、AI Speaker 同意、训练与人工访问、输出权利边界均已固化。当前不写生产、不开放索引；下一步生成三语言发布包并锁定最早 2026-09-23 受控发布。
