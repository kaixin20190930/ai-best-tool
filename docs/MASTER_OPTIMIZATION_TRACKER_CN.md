...
| MEASURE-02 | 数据治理与 Pilot 边界 | 原始 35 天、聚合 400 天、审计 90 天、20-flow 最小样本、最小权限、内部流量轮换和会议任务簇 Pilot allowlist | `MIGRATED / PREFLIGHT_BLOCKED / DISABLED`；[治理与 Pilot 文档](./MEASURE_02_DATA_GOVERNANCE_AND_PILOT_CN.md)，迁移与汇总 RPC 已验证；仍缺每日调度、内部 token、active task、verified evidence 和 Fireflies 实体，未接 UI、未开启采集 | Codex + Owner |
