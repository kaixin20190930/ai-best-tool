...
- P1：CHG-02 仍为 3/10。Gamma已完成定向采集并建立工具档案（4个官方来源、3条candidate、0冲突）；只有产品名和官网定位适合当前人工核验，定价候选摘录受CSS污染不得直接通过。至少一条无冲突事实人工核验后才能建立第4条真实基线，不新增页面、不用candidate冒充verified。
