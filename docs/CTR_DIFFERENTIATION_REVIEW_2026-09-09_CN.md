...
并行前置项历史结论：`INTAKE-BUF-01` 当时用于把成熟发布队列补到至少 7 条。自 2026-09-20 起，候选缓冲目标提高到 14-21 条，公开目标调整为每天 2 个、最多 3 个；索引仍独立审批。当前口径见 [规模化路线图](./CONTENT_SCALE_AND_MAINTENANCE_ROADMAP_2026-09-20_CN.md)。
