...
export default async function AdminOwnersPage({
  ...
  const sections = [
    ...
    },
    {
      ...
      description: isChinese ? '有邮箱但还没认领，适合继续人工跟进。' : 'Entries with an email but no completed claim.',
      ...
      <div className='rounded-2xl border border-cyan-100 bg-cyan-50 p-5 shadow-sm'>
        ...
        <div className='mt-4 grid gap-3 md:grid-cols-2 xl:grid-cols-4'>
          ...
          <div className='rounded-xl border border-white bg-white p-4 shadow-sm'>
            ...
            <p className='mt-2 text-lg font-bold text-slate-950'>{getNextFeaturedLabel(nextFeaturedTool, isChinese)}</p>
            <p className='mt-1 text-sm text-slate-600'>
