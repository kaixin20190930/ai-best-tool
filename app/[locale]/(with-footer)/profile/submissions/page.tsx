                      ...
                      if (tool.status === 'published') {
                        actionContent = (
                          <div className='flex flex-col items-end gap-2'>
                            ...
                            {(commercialStatus === 'pending_payment' || commercialStatus === 'payment_failed') &&
                              paymentUrl && (
                                <a
                                  href={paymentUrl}
                                  target='_blank'
                            ...
                            {commercialStatus === 'paid_published' && (
                              <div className='flex flex-wrap justify-end gap-1'>
                                {commercialDetails.sponsored ? (
                                  ...
                                  getRecord(getRecord(getRecord(tool.features).submission).commercial)
                                  ...
                                  <>
                                    <a
                                      href={getFeaturedPaymentUrl(tool, 3)}
                                      className='text-xs font-semibold text-amber-700 hover:text-amber-800'
                                    >
                                      Feature 3d
                                    </a>
                                    <a
                                      href={getFeaturedPaymentUrl(tool, 7)}
                                      className='text-xs font-semibold text-amber-700 hover:text-amber-800'
                                    >
                                      Feature 7d
                                    </a>
                                    <a
                                      href={getFeaturedPaymentUrl(tool, 14)}
                                      className='text-xs font-semibold text-amber-700 hover:text-amber-800'
                                    >
                                      Feature 14d
                                    </a>
