...
async function FavoritesList() {
  ...
  if (!result.success || result.favorites.length === 0) {
    return (
      <EmptyState title='No favorites yet' description='Start exploring AI tools and add them to your favorites!' />
    );
  }
  ...
  return (
    <div className='theme-page container mx-auto px-4 py-8'>
      <div className='mb-8'>
        ...
        <p className='mt-2 text-slate-600'>Manage your favorite AI tools in one place</p>
      </div>
