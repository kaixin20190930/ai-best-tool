...
const baselines: Record<string, DecisionBaseline> = {
  ...
  luma: {
    ...
    title: 'Decision baseline established',
    summary:
      'Luma AI supports video shot and visual concept exploration when a team can review generated details, iterate on outputs, and verify access and delivery terms for its chosen App or API workflow. Compare other video tools or a dedicated editor when exact product packaging, predictable accepted-shot cost, or full post-production control is required.',
    primarySourceUrl: 'https://lumalabs.ai/llm-info',
    sourceUrls: [
      'https://lumalabs.ai/',
      'https://lumalabs.ai/llm-info',
      'https://lumalabs.ai/pricing',
      'https://lumalabs.ai/learning-hub/keep-character-product-consistency-in-luma-reference-guide',
    ],
    bestFit: ['Video shot and visual concept exploration', 'Teams able to review generated details'],
    notIdealFor: [
      'Guaranteed frame-perfect product packaging without review',
      'Assuming API controls are available in every App account',
    ],
