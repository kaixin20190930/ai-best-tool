...
assert.equal(audit.actualPublishedAt, '2026-09-21');
...
assert(pipeline.includes('audit.releasedAt >= releaseNotBefore(candidate, audit)'), 'Released override date must use the audited effective window');
