...
assert.match(sql, /Published Task Capability conflicts with the planned importance/);
assert.match(sql, /Published Tool Capability conflicts with the planned supported capability or mapped evidence/);
assert.match(sql, /Published Tool Task Fit conflicts with the planned fit level or mapped evidence/);
assert.match(sql, /Seed Task Capability resolution was not completely reviewed or compatibly preserved as published/);
assert.match(sql, /Seed Tool Capability resolution was not completely reviewed or compatibly preserved as published/);
assert.match(sql, /Seed Tool Task Fit resolution was not completely reviewed or compatibly preserved as published/);
