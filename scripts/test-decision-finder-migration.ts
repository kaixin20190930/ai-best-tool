...
assert.match(sql, /IF TG_TABLE_NAME = 'tool_decision_profiles' THEN/);
assert.match(sql, /IF TG_TABLE_NAME = 'tool_task_fits' THEN/);
assert.match(sql, /IF TG_TABLE_NAME = 'tool_relationships' THEN/);
