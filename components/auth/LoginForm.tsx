...
export function LoginForm({ redirectTo }: { redirectTo?: string }) {
  ...
  return (
    <div className='theme-surface w-full max-w-md space-y-6 rounded-lg p-6 lg:p-8'>
      ...
      {/* eslint-disable-next-line react/jsx-props-no-spreading -- FormProvider needs the full form methods object */}
      <Form {...form}>
      ...
      <div className='grid grid-cols-2 gap-4'>
        <Button type='button' variant='outline' onClick={() => handleOAuthSignIn('google')} disabled={isLoading}>
        ...
        <Button type='button' variant='outline' onClick={() => handleOAuthSignIn('github')} disabled={isLoading}>
