...
这是一个由[AI Best Tools AI工具导航站](https://aibesttool.com)开源的AI导航站项目。我们的目标是让大家很容易就拥有一个属于自己的AI导航站，
收录自己喜欢的AI工具产品。这个项目非常轻量级，维护简单，适合对AI导航站感兴趣的个人开发者，也适合对NextJs有兴趣的学习者，
欢迎大家fork和star。

[English](https://github.com/6677-ai/AI Best Tools-ai-webui/blob/main/README.md) | 简体中文
...
![tai4-ai](./public/images/AI Best Toolsai.zh-CN.png)

## 感谢关注链接

欢迎关注我们的Twitter: https://x.com/AI Best Toolsai
...
如果你对项目有兴趣，欢迎扫描二维码加微信群沟通： ![AI Best Tools-ai-wx-group](./public/images/640.jpg)
...
```sh
# 你的域名
NEXT_PUBLIC_SITE_URL="https://www.aibesttool.com"
...
# 底部的联系邮箱
CONTACT_US_EMAIL="contact@aibesttool.com"
...
## 打算在 aibesttool.com 上提交您的网站？

### 打算将您的网站添加到我们的 `/startup` 页面？

- 在这里打开一个问题：[AI Best Tools-AI-Directory](https://github.com/6677-ai/AI Best Tools-AI-Directory/issues)
- 给我们发邮件：[contact@aibesttool.com](mailto:contact@aibesttool.com)
...
问：[AI Best Tools AI](https://aibesttool.com)
...
访问：: [6677-ai/AI Best Tools-ai-crawler](https://github.com/6677-ai/AI Best Tools-ai-crawler), 即将上线
